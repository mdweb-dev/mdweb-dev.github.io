...
window.addEventListener("DOMContentLoaded", function () {
  var pxToRem = function pxToRem(px) {
    ...
    return "".concat(px / base, "rem");
  };
  var heroIntroCss = (0,_emotion_css__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        display: flex;\n        align-items: flex-end;\n        width: 100%;\n        height: 100vh;\n        padding: ", ";\n        background-color: #fff;\n        background-position: center;\n        background-size: cover;\n        background-repeat: no-repeat;\n        @media (max-width: 768px) {\n            padding: ", " 0;\n        }\n    "])), pxToRem(48), pxToRem(48));
  var heroIntroTitleCss = (0,_emotion_css__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n        font-weight: 700;\n        font-size: ", ";\n        line-height: 1.25;\n        letter-spacing: -0.02em;\n        text-transform: uppercase;\n        color: #fff;\n        span, mark {\n          color: #71c575;\n          background-color: transparent;\n        }\n        @media (max-width: 767px) {\n            font-size: ", ";\n        }\n    "])), pxToRem(72), pxToRem(36));
  var aboutCompanyCss = (0,_emotion_css__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n        position: sticky;\n        top: 0;\n        overflow: hidden;\n        min-height: 100vh;\n        .dark-mode & {\n            background-color: #000;\n        }\n    "])));
  var aboutCompanyTitleCss = (0,_emotion_css__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n        padding: ", ";\n        font-weight: 700;\n        font-size: ", ";\n        line-height: 150%;\n        letter-spacing: -0.02em;\n        text-transform: uppercase;\n        color: #000;\n        .dark-mode & {\n        color: #fff;\n        }\n        @media (max-width: 1199px) {\n          padding: ", " 0 0;\n        }\n        @media (max-width: 767px) {\n          font-size: ", ";\n        }\n    "])), pxToRem(48), pxToRem(40), pxToRem(48), pxToRem(28));
  var aboutCompanyWrapperCss = (0,_emotion_css__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n        display: grid;\n        grid-template-columns: repeat(2, 1fr);\n        @media (max-width: 1199px) {\n          grid-template-columns: 1fr;\n        }\n    "])));
  var aboutCompanyPictureCss = (0,_emotion_css__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n        padding: ", ";\n        font-size: 0;\n        @media (max-width: 1199px) {\n          padding: ", " 0;\n        }\n        img {\n          width: 100%;\n          transform: scale(5);\n        }\n    "])), pxToRem(48), pxToRem(24));
  var aboutCompanyMainCss = (0,_emotion_css__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n        display: flex;\n        flex-direction: column;\n        justify-content: space-between;\n        padding: ", ";\n        border-left: ", " solid #ccc;\n        @media (max-width: 1199px) {\n          padding: ", " 0;\n          border-left: none;\n          border-top: ", " solid #ccc;\n        }\n    "])), pxToRem(48), pxToRem(1), pxToRem(24), pxToRem(1));
  var aboutCompanyCountCss = (0,_emotion_css__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n        font-weight: 900;\n        font-size: ", ";\n        line-height: 125%;\n        letter-spacing: -0.02em;\n        text-transform: uppercase;\n        color: #71c575;\n        @media (max-width: 767px) {\n          font-size: ", ";\n        }\n    "])), pxToRem(80), pxToRem(48));
  var aboutCompanyAboutCss = (0,_emotion_css__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n        font-weight: 400;\n        font-size: ", ";\n        line-height: 150%;\n        letter-spacing: -0.02em;\n        color: #000;\n        .dark-mode & {\n            color: #fff;\n        }\n        @media (max-width: 767px) {\n          margin-top: ", ";\n        }\n        p,ul,ol,table,blockquote{\n          margin-bottom: ", ";\n        }\n        ul,ol{\n          padding-left: ", ";\n        }\n        *:last-child {\n          margin-bottom: 0;\n        }\n    "])), pxToRem(16), pxToRem(24), pxToRem(15), pxToRem(24));
  var aboutCompanyMaskCss = (0,_emotion_css__WEBPACK_IMPORTED_MODULE_0__.css)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n        position: absolute;\n        inset: 0;\n        display: flex;\n        align-items: flex-end;\n        padding: ", ";\n        width: 100%;\n        height: 100vh;\n        z-index: 10;\n        pointer-events: none;\n    "])), pxToRem(48));
  var heroIntro = document.querySelector('.hero-intro');
  var heroIntroTitle = document.querySelector('.hero-intro__title');
  var aboutCompany = document.querySelector('.about-company');
  var aboutCompanyTitle = document.querySelector('.about-company__title');
  var aboutCompanyWrapper = document.querySelector('.about-company__wrapper');
  var aboutCompanyPicture = document.querySelector('.about-company__picture');
  var aboutCompanyMain = document.querySelector('.about-company__main');
  var aboutCompanyCount = document.querySelector('.about-company__count');
  var aboutCompanyAbout = document.querySelector('.about-company__about');
  var aboutCompanyMask = document.querySelector('.about-company__mask');
