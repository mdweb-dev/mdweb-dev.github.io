$(document).ready(function () {
    ...
    function firmaMwst() {
        ...
        if ( $("#billing_first_name").val() == "" || $("#billing_last_name").val() == "" || $("#billing_address_1").val() == "" || $("#billing_postcode").val() == ""|| $("#billing_city").val() == "" || $("#billing_phone").val() == "" || $("#billing_email").val() == "" ) {
            $('.bezahlung-buylist').addClass('loadingOverlay');
        } else {
            $('.bezahlung-buylist').removeClass('loadingOverlay');
        }
    }
    setInterval(function () {
        firmaMwst();
