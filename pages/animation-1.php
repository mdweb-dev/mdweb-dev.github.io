...
<div class="wrapper">
    ...
    <main class="main js-trigger">
        <section class="hero-intro" style="background-image: url('../assets/img/hero-intro.jpg')">
            <div class="hero-intro__container">
                <div class="hero-intro__display">
                    <h1 class="hero-intro__title js-title-intro">
                        <mark>Керуємо</mark>
                        <br>
                        НЕРУХОМІСТЮ
                        <br>
        ...
        <section class="about-company js-about-company">
            <div class="about-company__container">
                ...
                <div class="about-company__wrapper">
                    <picture class="about-company__picture js-company-picture">
